...
const KNOWN_BETA_HEADERS = [
	{
		prefix: "computer-use-",
		labelKey: "betaHeaders.headers.computerUse.label",
		descriptionKey: "betaHeaders.headers.computerUse.description",
		defaults: { anthropic: true, vertex: true, bedrock: true, bedrock_mantle: true, azure: true },
	},
	{
		prefix: "structured-outputs-",
		labelKey: "betaHeaders.headers.structuredOutputs.label",
		descriptionKey: "betaHeaders.headers.structuredOutputs.description",
		defaults: { anthropic: true, vertex: false, bedrock: true, bedrock_mantle: true, azure: true },
	},
	{
		prefix: "advanced-tool-use-",
		labelKey: "betaHeaders.headers.advancedToolUse.label",
		descriptionKey: "betaHeaders.headers.advancedToolUse.description",
		defaults: { anthropic: true, vertex: false, bedrock: false, bedrock_mantle: false, azure: true },
	},
	{
		prefix: "mcp-client-",
		labelKey: "betaHeaders.headers.mcpClient.label",
		descriptionKey: "betaHeaders.headers.mcpClient.description",
		defaults: { anthropic: true, vertex: false, bedrock: false, bedrock_mantle: false, azure: true },
	},
	{
		prefix: "prompt-caching-scope-",
		labelKey: "betaHeaders.headers.promptCachingScope.label",
		descriptionKey: "betaHeaders.headers.promptCachingScope.description",
		defaults: { anthropic: true, vertex: false, bedrock: false, bedrock_mantle: false, azure: true },
	},
	{
		prefix: "compact-",
		labelKey: "betaHeaders.headers.compaction.label",
		descriptionKey: "betaHeaders.headers.compaction.description",
		defaults: { anthropic: true, vertex: true, bedrock: true, bedrock_mantle: true, azure: true },
	},
	{
		prefix: "context-management-",
		labelKey: "betaHeaders.headers.contextManagement.label",
		descriptionKey: "betaHeaders.headers.contextManagement.description",
		defaults: { anthropic: true, vertex: true, bedrock: true, bedrock_mantle: true, azure: true },
	},
	{
		prefix: "files-api-",
		labelKey: "betaHeaders.headers.filesApi.label",
		descriptionKey: "betaHeaders.headers.filesApi.description",
		defaults: { anthropic: true, vertex: false, bedrock: false, bedrock_mantle: false, azure: true },
	},
	{
		prefix: "interleaved-thinking-",
		labelKey: "betaHeaders.headers.interleavedThinking.label",
		descriptionKey: "betaHeaders.headers.interleavedThinking.description",
		defaults: { anthropic: true, vertex: true, bedrock: true, bedrock_mantle: true, azure: true },
	},
	{
		prefix: "skills-",
		labelKey: "betaHeaders.headers.skills.label",
		descriptionKey: "betaHeaders.headers.skills.description",
		defaults: { anthropic: true, vertex: false, bedrock: false, bedrock_mantle: false, azure: true },
	},
	{
		prefix: "context-1m-",
		labelKey: "betaHeaders.headers.context1m.label",
		descriptionKey: "betaHeaders.headers.context1m.description",
		defaults: { anthropic: true, vertex: true, bedrock: true, bedrock_mantle: true, azure: true },
	},
	{
		prefix: "fast-mode-",
		labelKey: "betaHeaders.headers.fastMode.label",
		descriptionKey: "betaHeaders.headers.fastMode.description",
		defaults: { anthropic: true, vertex: false, bedrock: false, bedrock_mantle: false, azure: false },
	},
	{
		prefix: "redact-thinking-",
		labelKey: "betaHeaders.headers.redactThinking.label",
		descriptionKey: "betaHeaders.headers.redactThinking.description",
		defaults: { anthropic: true, vertex: false, bedrock: false, bedrock_mantle: false, azure: true },
	},
] as const;
...
export function BetaHeadersFormFragment({ provider }: BetaHeadersFormFragmentProps) {
	...
	const onSubmit = (data: BetaHeadersFormSchema) => {
		...
		updateProvider(
			...
			.unwrap()
			.then(() => {
				toast.success(t("betaHeaders.toasts.updated"));
				form.reset(data);
			})
			.catch((err) => {
				toast.error(t("betaHeaders.toasts.updateFailed"), {
	...
	const addCustomPrefix = useCallback(() => {
		...
		if (KNOWN_PREFIXES.has(prefix)) {
			setNewPrefixError(t("betaHeaders.errors.knownHeader"));
			return;
		}
		if (overrides[prefix] !== undefined) {
			setNewPrefixError(t("betaHeaders.errors.alreadyExists"));
			return;
		}
		if (!/^[a-z0-9-]+$/.test(prefix)) {
			setNewPrefixError(t("betaHeaders.errors.invalidCharacters"));
			return;
		}
		...
		<Form {...form}>
			<form onSubmit={form.handleSubmit(onSubmit)} data-testid="provider-config-beta-headers-content">
				<div className="space-y-2 px-6 pb-6">
					<p className="text-muted-foreground text-xs">{t("betaHeaders.intro")}</p>
					<div className="rounded-md border">
						<table className="w-full text-sm">
							<thead>
								<tr className="border-b">
									<th className="px-3 py-2 text-left font-medium">{t("betaHeaders.columns.header")}</th>
									<th className="px-3 py-2 text-left font-medium">{t("betaHeaders.columns.default")}</th>
									<th className="w-[180px] px-3 py-2 text-left font-medium">{t("betaHeaders.columns.override")}</th>
								</tr>
							</thead>
							<tbody>
								{headerRows.map((row) => (
									<tr key={row.prefix} className="border-b last:border-b-0">
										...
										<td className="px-3 py-2">
											<Badge variant={row.defaultSupported ? "default" : "secondary"} className="text-xs">
												{row.defaultSupported ? t("betaHeaders.supported") : t("betaHeaders.unsupported")}
											</Badge>
										</td>
										<td className="w-[180px] px-3 py-2">
											...
											>
												...
												<SelectContent>
													<SelectItem value="default">{t("betaHeaders.default")}</SelectItem>
													<SelectItem value="enabled">{t("betaHeaders.supported")}</SelectItem>
													<SelectItem value="disabled">{t("betaHeaders.unsupported")}</SelectItem>
												</SelectContent>
											</Select>
										</td>
									</tr>
									...
									<tr key={prefix} className="border-b last:border-b-0">
										<td className="px-3 py-2">
											<div className="flex flex-col gap-0.5">
												...
												<span className="text-muted-foreground text-xs">{t("betaHeaders.customHeader")}</span>
											</div>
										</td>
										<td className="px-3 py-2">
											<Badge variant="outline" className="text-xs">
												{t("betaHeaders.custom")}
											</Badge>
										</td>
										<td className="w-[180px] px-3 py-2">
											<div className="flex items-center gap-1">
												...
												<Button
													...
													aria-label={t("betaHeaders.removePrefixAria", { prefix })}
												>
					...
					<div className="flex items-start gap-2 pt-2">
						<div className="flex-1">
							<Input
								placeholder={t("betaHeaders.addPrefixPlaceholder")}
								value={newPrefix}
								onChange={(e) => {
								...
								aria-label={t("betaHeaders.addPrefixAria")}
