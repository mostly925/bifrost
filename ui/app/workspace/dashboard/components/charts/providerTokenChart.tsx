					...
					return (
						<div key={provider} className="flex items-center justify-between gap-4">
							<span className="flex items-center gap-1.5">
								...
								<span className="max-w-[120px] truncate text-zinc-600 dark:text-zinc-400">{isOther ? t("chart.otherSeries") : provider}</span>
							</span>
			...
			<div className="space-y-1 text-sm">
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
						...
						<span className="text-zinc-600 dark:text-zinc-400">{t("chart.input")}</span>
					</span>
				...
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
						...
						<span className="text-zinc-600 dark:text-zinc-400">{t("chart.output")}</span>
					</span>
					<span className="font-medium">{formatCompactNumber(stats.completion_tokens || 0)}</span>
				</div>
				<div className="flex items-center justify-between gap-4 border-t border-zinc-200 pt-1 dark:border-zinc-700">
					<span className="text-zinc-600 dark:text-zinc-400">{t("chart.total")}</span>
