			...
			<div className="space-y-1 text-sm">
				<div className="mt-2 flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
						...
						<span className="text-zinc-600 dark:text-zinc-400">{t("volume.total")}</span>
					</span>
				...
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
						...
						<span className="text-zinc-600 dark:text-zinc-400">{t("volume.success")}</span>
					</span>
				...
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
						...
						<span className="text-zinc-600 dark:text-zinc-400">{t("volume.error")}</span>
					</span>
				...
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
						...
						<span className="text-zinc-600 dark:text-zinc-400">{t("volume.cancelled")}</span>
					</span>
			...
			<Collapsible open={isOpen} onOpenChange={onOpenChange}>
				<div className="flex items-center justify-between">
					<CollapsibleTrigger data-testid="logs-volume-chart-trigger" className="flex items-center gap-2 hover:opacity-80">
						...
						<span className="text-muted-foreground text-sm font-medium">{t("volume.title")}</span>
					</CollapsibleTrigger>
					<div className="mr-2 flex items-center gap-4">
						{isOpen && (
							<div className="flex items-center gap-3 text-xs">
								<span className="flex items-center gap-1.5">
									<span className="h-2 w-2 rounded-full bg-emerald-500" />
									<span className="text-muted-foreground">{t("volume.success")}</span>
								</span>
								<span className="flex items-center gap-1.5">
									<span className="h-2 w-2 rounded-full bg-red-500" />
									<span className="text-muted-foreground">{t("volume.error")}</span>
								</span>
								<span className="flex items-center gap-1.5">
									<span className="h-2 w-2 rounded-full bg-zinc-400" />
									<span className="text-muted-foreground">{t("volume.cancelled")}</span>
								</span>
							</div>
						)}
